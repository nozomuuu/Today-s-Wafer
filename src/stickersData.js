...
function App() {
    ...
    // 修正箇所：useMemo に handleStickerClick を依存配列に追加
    const memoizedTodayStickers = useMemo(() => todayStickers, [todayStickers, handleStickerClick]);
            ...
            {page === "main" && (
                <div className="main-container">
                    ...
                    <div className="collected-stickers">
                        {memoizedTodayStickers.map((sticker, index) => (
                            <img
                                key={index}
                                src={sticker.image}
                                alt={`Sticker ${index + 1}`}
